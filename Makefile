...
#    Updated: 2016/12/20 11:56:16 by mtacnet          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC = ft_atoi.c ft_bzero.c ft_countword.c ft_intlen.c ft_isalnum.c \
	  ...
	  ft_toupper.c ft_swap.c

OBJ = ft_atoi.o ft_bzero.o ft_countword.o ft_intlen.o ft_isalnum.o \
	  ...
	  ft_lstnew.o ft_lstrepel.o ft_memalloc.o ft_memccpy.o ft_memchr.o \
